...
const ContactBar = () => {
  ...
  return (
    <Box w="30%" height={"100vh"} borderRight="2px solid black">
      {/* =================TOPBAr===================== */}
      ...
      <Flex direction={"row"} width={"100%"} p={2}>
        <Flex justifyContent="space-between" width={"100%"}>
          <Search2Icon
            style={{ fontSize: "23px", marginTop: "7px", marginRight: "5px" }}
          />
          <Input
          ...
          <Box position="relative" right={0}>
            <BsFillCaretDownFill
              style={{ fontSize: "25px", marginTop: "7px", cursor: "pointer" }}
            />
          </Box>
        </Flex>
        <HStack></HStack>
      ...
      <VStack space={4} overflow={"scroll"} height="72vh">
        ...
        <Flex gap={5} width={"100%"} p={2}>
          ...
          <VStack
            ...
            style={{ cursor: "pointer" }}
          >
            <Text backgroundColor="#dddd" width={100}>
              Aaro gupta
            </Text>
      ...
      >
        ...
        <Text fontSize={14}>
          ...
          <span style={{ color: "#179cd2", cursor: "pointer" }}>
